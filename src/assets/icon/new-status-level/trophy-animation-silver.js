...
(lib.trophy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#606060").s().p("");
	this.shape.setTransform(140.5,203);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#606060").s().p("");
	this.shape_1.setTransform(140.7,83.5);
	...
	this.shape_2.graphics.f("#C0C0C0").s().p("An8CkIAAhEIP5AAIAABEgAmNBEIAAjnIMhAAIAADng");
	this.shape_2.setTransform(140.7,207.5);

	this.instance_1 = new lib.Path();
	this.instance_1.parent = this;
	this.instance_1.setTransform(140.7,203.9,1,1,0,0,0,22.8,16.1);
	this.instance_1.alpha = 0.102;

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#959594").s().p("AnJCiIAAlDIOTAAIAAFDg");
	this.shape_3.setTransform(140.6,203.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#C0C0C0").s().p("AmAAXQgJAAgIgHQgHgGAAgKQABgIAGgHQAHgHAKAAIMBAAQAKAAAGAHQAIAGgBAJQABAKgIAGQgGAHgKAAg");
	this.shape_4.setTransform(140.6,187.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#E7B89A").s().p("AA7BBIg4gdQg4gegGgKQgFgMBCApQAiAUAiAYgAASgnQgygJgWgCQgfgEgFgJQgFgJAbAHQAhAJB0AAIALAVIgRABQgXAAgigFg");
	this.shape_5.setTransform(140.6,216.9);
	...
	this.shape_6.graphics.f("#959594").s().p("");
	this.shape_6.setTransform(140.6,93.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#959594").s().p("Al9MFQDqhaAziyQAQg3gFg6IgHguIBXgRIACAAIBVARIgHAvQgEA5AQA4QAzCyDrBZgApXkBQg0ijgUjAIgJigIVRAAQAABAgJBgQgUDAg1CjQioIImvAhQmvghiooIg");
	this.shape_7.setTransform(140.7,109.3);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.shape_7},{t:this.shape_6},{t:this.instance_2},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.instance_1},{t:this.shape_2},{t:this.instance},{t:this.shape_1},{t:this.shape}]}).wait(1));
...
// stage content:
(lib.trophyanimationsilver = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
